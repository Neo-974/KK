...
> **Projet indépendant.** Ce dossier `etransmed/` est totalement séparé du projet KK
> (SaaS élus locaux) présent à la racine du dépôt. eTransMed ne modifie aucun fichier de KK.
